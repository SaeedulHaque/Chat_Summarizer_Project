...
if __name__ == "__main__":
    ...
    p.add_argument("--bart-model", default="lidiya/bart-large-xsum-samsum",
                   help="Hugging Face model ID for BART")
    p.add_argument("--bart-device", type=int, default=-1,
                   help="-1 for CPU or GPU index")
